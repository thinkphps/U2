...
<head>
    <meta charset="UTF-8">
    <title>优衣库 - 虚拟试衣间 | 一个可以按气温、穿衣场合及风格快速为您推荐搭配组合的智能衣柜</title>
    <meta name="keywords" content="优衣库 虚拟试衣间,搭配,服装搭配,男装搭配,女装搭配,童装搭配,看天气,学搭配" />
    <meta name="description" content="优衣库 - 虚拟试衣间 | 一个可以按气温、穿衣场合及风格快速为您推荐搭配组合的智能衣柜" />
...
<!--提示-->
<div class="tsxx1 ">
    <a href="javascript:;" id="tsClose">知道了</a>
</div>


<!--新旧版切换按钮-->
<div class="version_o">
    <a href="<?php echo U('IndexNew/index');?>" class="new_v"></a>
    <a href="javascript:;" class="old_v"></a>
</div>
...
<div class="login_bar pr">
    <?php if($uniq_user_name == ''): ?><span>欢迎来到虚拟试衣间</span>
...
<div class="mini-cabnet pr clear">
    <div class="mini-cab pr fl">
        ...
        <div class="mini-cab-share">
            ...
            <div class="jiathis_style_24x24 clear" onmouseover="funcShare()">
            ...
            <script type="text/javascript" >
                var jiathis_config={
                    url:"http://uniqlo.bigodata.com.cn/u1_5/",
                    summary:"#我的专属衣柜#尽情试穿自己喜欢的衣服，挑选最心仪的搭配。在虚拟试衣间里，就好像拥有了整个优衣库~小伙伴们，一起来打造专属你的私人衣柜吧！@优衣库官方网络旗舰店 ",
                    title : " ",
                ...
                funcShare = function(){
                    var src = $('div.mini-cab-container').map(function(){
...
<div class="mini-wea fb clear pr">
    <span class="mini-beta">测试版</span>
    <a href="javascript:;" class="fj_shop " id="shopinfo"></a>
...
<div class="mini-cate">
    <div class="mini-gender-bin tc">
        <ul class="mini-gender fl">
            ...
            <li>
                <a href="javascript:;" data-key="kids" class="mini-gender-kids" id='3'>KIDS</a>
            </li>
            <li>
                <a href="javascript:;" data-key="baby" class="mini-gender-baby" id='4'>BABY</a>
            </li>
        </ul>
    </div>

    <div class="mini-cate-ps clear tc">
        <div class="mini-cate-place pr fl">
            ...
            <div class="mini-place-mask pa"></div>
        </div>
    ...
    <div class="mini-design clear pr">
        ...
        <div class="mini-fm fl mini-checked-all">
            ...
            <div>
                ...
                <div class="mini-baby-ul none">
                    <ul class="clear tc" data-pos="baby">
                        <?php if(is_array($babycate)): $i = 0; $__LIST__ = $babycate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bvo): $mod = ($i % 2 );++$i;?><li><a href="javascript:;" id="<?php echo ($bvo["id"]); ?>"><?php echo ($bvo["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
            </div>
        </div>
...
<div id="nio-kv" class="index-bin noborder pr">
    ...
    <p class="index-final-tip">注：衣物实际库存及价格请参照优衣库官方网站</p>
...
<!-- 地图弹窗 -->
<div class="map_light_box none" id="mapdiv">
    <a href="javascript:;" class="light_box_close" id="closemap"></a>
    <h3>查找您附近的优衣库UNIQLO门店</h3>
    <div class="light_box_u_map_con" id="allmap">
    </div>
</div>
...
<div class="mini-succ mini-pop tc pf none">
    ...
    <p>
        ...
        <a href="javascript:;" class="mini-succ-enter">进入衣柜</a>
    </p>
</div>
...
<div class="mini-reg-succ mini-pop pf none">
    <h3>注册提交成功！</h3>
    <p>请发送短信“优衣库 虚拟试衣间”至号码10690183668，激活帐号。激活帐号后，可享用优衣库不定期发放的优惠券。</p>
...
<div class="mini-activate-fail mini-pop pf smaller none">
    ...
    <!-- <p>关联手机号与激活手机号不相符，请重新发送。<br>请发送短信“优衣库 虚拟试衣间”至号码15000326906，激活帐号。</p> -->
    <button>确定</button>
</div>

<!-- 退出登录 -->
<div class="mini-logout-confirm mini-pop pf none" id="logout">
    <h3>您确定要离开优衣库虚拟试衣间吗？</h3>
    <p>您的帐号尚未激活，直接退出将丢失所有衣柜中保存的衣物<br>请点击“激活账号”验证您手机号码，享有优衣库虚拟试衣间保存功能</p>
    <p class="mt20">
...
<div class="mini-activate-fail2 mini-pop pf none">
    <h3>抱歉，未能成功激活。</h3>
    <p>关联手机号与激活手机号不相符，请重新发送。<br>请发送短信“优衣库 虚拟试衣间”至号码10690183668，激活帐号。</p>
...
<div class="mini-activate-notice mini-pop pf  <?php if($is_active == 0): ?>none<?php endif; ?>">
  <h3>帐号激活提醒</h3>
  <p>发送“优衣库 虚拟试衣间”至以下号码，激活帐号。<br>立即享用优衣库不定期发放的线上优惠券。<br>
...
<form class="mini-relate mini-pop pf <?php if($is_phone == 0): ?>none<?php endif; ?>">
  <h3>关联手机号码</h3>
  <p>马上关联手机号码，尊享优衣库 虚拟试衣间搭搭看所有功能。</p>
  <div class="mini-control">
    <label class="mini-label">用户名</label>
...
<div class="mini-clause mini-pop pf none">
    <h3>隐私声明</h3>
    <div>
        <p>优衣库 虚拟试衣间（【uniqlo.bigodata.com.cn】，以下称“本网站”）隐私保护声明系本网站保护用户个人隐私的承诺。鉴于网络的特性，本网站将无可避免地与您产生直接或间接的互动关系，故特此说明本网站对用户个人信息所采取的收集、使用和保护政策，请您务必仔细阅读：</p>
        <b>一、非个人化信息</b>
        <p>我们将通过您的IP地址来收集非个人化的信息，例如您的浏览器性质、操作系统种类、给您提供接入服务的ISP的域名等，以优化在您计算机屏幕上显示的页面。通过收集上述信息，我们亦进行客流量统计。</p>
        <p>这些无关个人身份的信息能帮助我们辨别虚拟试衣间最受欢迎的地区并确定我们推广活动的有效性。此外，我们也可能将这些信息披露给我们的广告客户，使他们知道点击他们广告的人数。</p>
        <b>二、个人资料</b>
        <p>当您在优衣库虚拟试衣间进行用户注册登记、网上购物等活动时，在您的同意及确认下，本网站将通过注册表格、订单等形式要求您提供一些个人资料。这些个人资料包括：</p>
        <p>1、个人识别资料：如姓名、性别、年龄、出生日期、电话、手机号码、通信地址、电子邮件地址等。</p>
        <p>2、个人背景： 职业、教育程度、收入状况、婚姻、家庭状况。</p>
        <p>请了解，在未经您同意及确认之前，本网站不会将您为参加本网站之特定活动所提供的资料利用于其它目的。唯有按下列第六条规定的应政府及法律要求披露时不在此限。虚拟试衣间收集这类关于个人身份的信息主要是为了其注册成员能够更容易和更满意地使用虚拟试衣间的网页。我们的目标是向所有的互联网用户提供愉快、有益、有趣的上网经历。而这些个人信息有助于我们实现这一目标。</p>
        ...
        <p>（3）随时请求删除；</p>
        <p>（4）请求停止电脑处理及利用。</p>
        <p>2、虚拟试衣间为其用户提供的网上游戏项目，为了参加抽签，我们通常要求申请者在联系方法(通讯地址和电话)之外，还要根据其个人兴趣填写表格。此类信息被虚拟试衣间用来累积其用户的数据。如果用户不想提供所要求的信息和参加比赛，这完全是用户的决定。</p>
        ...
        <p>链接</p>
        <p>3、虚拟试衣间的网页上有与其他网站网页的链接，包括旗帜广告和网页上的其他广告。虚拟试衣间对其他任何网站的内容、隐私政策或运营，或经营这些网站的公司的行为概不负责。在向这些与虚拟试衣间链接的网站提供个人信息之前，请查阅它们的隐私政策。</p>
        <p>4、由于与本网站链接的其它网站所造成之个人资料泄露及由此而导致的任何法律争议和后果。</p>
        <p>本网站之保护隐私声明的修改及更新权均属于优衣库虚拟试衣间<br>联络方式为：【<a href="mailto:u@BIGOData.com.cn">u@BIGOData.com.cn</a>】</p>
    </div>
...
<script type="text/javascript" src="__TMPL__Public/js/nio-weather-new.js"></script>
...
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=490472aa5a1a905fe261a5a00ed1d86c"></script>
<script type="text/javascript" src="__TMPL__Public/js/Map/H.min.js"></script>
...
var luid = '<?php echo ($uniq_user_name); ?>',isuturl = '<?php echo U('Getisut/index');?>';
var tmplPath = '<?php echo __TMPL__Public;?>';
var getweatherurl = '<?php echo U('API/GetWeatherByCityID');?>';
$(function(){
