      ...
      <div class="mini-fm fl mini-checked-all">
        ...
        <div>
          ...
          <div class="mini-baby-ul none">
            <ul class="clear tc">
              <li><a href="javascript:;" id="aaaaa">茄克</a></li>
              <li><a href="javascript:;" id="aaaaa">羽绒服</a></li>
              <li><a href="javascript:;" id="aaaaa">外套</a></li>
              <li><a href="javascript:;" id="aaaaa">大衣</a></li>
              <li><a href="javascript:;" id="aaaaa">牛仔裤</a></li>
              <li><a href="javascript:;" id="aaaaa">长裤</a></li>
              <li><a href="javascript:;" id="aaaaa">卫裤</a></li>
            </ul>
          </div>
        </div>
      </div>
...
function addwardrobe(id, onFailCallback, onSuccCallback){
  if(id>0){
     ...
     onFailCallback();
  	...
  	if(k==1){
    addCookie('nologiid'+flagisud,noiid+id+'_');
  	onSuccCallback();		
  	}	
  	}else{
  	...
  	addCookie('nologiid'+flagisud,id+'_');
  	onSuccCallback();
  	}
