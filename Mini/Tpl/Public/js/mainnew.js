...
//        cabnet.mapLightBox.addClass("position","fixed");
        ...
        /*************************addby jack.wu   2014年2月11日*****************************/
            //cab框隐藏
        cabnet.btnFold.on('click',function(){
            //显示展开按钮
            cabnet.btnExpansion.show();
            //隐藏左边的cab框
            cabnet.cab.hide();
            //将衣柜宽度设置为100%
            cabnet.net.width("100%");
        })

        //cab框显示
        cabnet.btnExpansion.on('click',function(){
            //隐藏展开按钮
...
//            Model.DressingByBarcode('UQ08851140','15581');
        ...
        function netHoverCallback(pos, rest){                  // 图片悬浮的callback
            ...
            /***********得到颜色、性别、和uq      addby jack.wu   2014年2月11日 20:09:07******/
