...
public function ajaxgood(){
   ...
   $dclothes = array();
    ...
    foreach($reulist as $k=>$v){
      ...
      $ustr.='<li><img fg="'.$v['ccateid'].'" src="http://phoneicolor.networking.io/uniqlo/'.$v['pic_url'].'" id="1" place="家居1" tag="淑女1" url="'.$v['detail_url'].'" rest="'.$v['num'].'" price="'.$v['price'].'" miniUrl="'.C('UNIQLOURL').'mini.php/Index/index/num/'.$v['num_iid'].'" alt="'.$v['title'].'"></li>';
      }
	...
	$v['title'] = iconv('utf8','gbk',$v['title']);
    $dstr.='<li><img fg="'.$v['ccateid'].'" src="http://phoneicolor.networking.io/uniqlo/'.$v['pic_url'].'" id="10" place="家居2" tag="淑女10" url="'.$v['detail_url'].'" rest="'.$v['num'].'" price="'.$v['price'].'" miniUrl="'.C('UNIQLOURL').'mini.php/Index/index/num/'.$v['num_iid'].'" alt="'.$v['title'].'"></li>';
	}
...
public function getgood(){
   ...
   foreach($redlist as $k=>$v){
    ...
    foreach($uclothes as $k=>$v){
	  $v['title'] = iconv('utf8','gbk',$v['title']);
      $ustr.='<li><img fg="'.$v['ccateid'].'" src="http://phoneicolor.networking.io/uniqlo/'.$v['pic_url'].'" id="1" place="家居1" tag="淑女1" url="'.$v['detail_url'].'" rest="'.$v['num'].'" price="'.$v['price'].'" alt="'.$v['title'].'" miniUrl="'.C('UNIQLOURL').'mini.php/Index/index/num/'.$v['num_iid'].'"></li>';
      }	
	}
	$ustr = iconv('gbk','utf8',$ustr);
    $arr['ustr'] = $ustr;
	...
	foreach($dclothes as $k=>$v){
	$v['title'] = iconv('utf8','gbk',$v['title']);
    $dstr.='<li><img fg="'.$v['ccateid'].'" src="http://phoneicolor.networking.io/uniqlo/'.$v['pic_url'].'" id="10" place="家居2" tag="淑女10" url="'.$v['detail_url'].'" rest="'.$v['num'].'" price="'.$v['price'].'" alt="'.$v['title'].'" miniUrl="'.C('UNIQLOURL').'mini.php/Index/index/num/'.$v['num_iid'].'"></li>';
	}
    }
	$dstr = iconv('gbk','utf8',$dstr);
    $arr['dstr'] = $dstr;
	...
	$v['title'] = iconv('utf8','gbk',$v['title']);
    $tstr.='<li><img src="http://phoneicolor.networking.io/uniqlo/'.$v['pic_url'].'" id="10" place="家居2" tag="淑女10" url="'.$v['detail_url'].'" rest="'.$v['num'].'" price="'.$v['price'].'" alt="'.$v['title'].'"></li>';
	}
