...
public function ajaxgood(){
   ...
   $dclothes = array();
    ...
    foreach($reulist as $k=>$v){
      ...
      $ustr.='<li><img fg="'.$v['ccateid'].'" data-original="http://uniqlo.bigodata.com.cn/'.$v['pic_url'].'" id="1" place="家居1" tag="淑女1" url="'.$v['detail_url'].'" rest="'.$v['num'].'" price="'.$v['price'].'" alt="'.$v['title'].'" miniUrl="'.C('UNIQLOURL').'mini.php/Index/index/num/'.$v['num_iid'].'">
              </li>';
      }
	...
	$v['title'] = iconv('utf8','gbk',$v['title']);
    $dstr.='<li><img fg="'.$v['ccateid'].'" data-original="http://uniqlo.bigodata.com.cn/'.$v['pic_url'].'" id="10" place="家居2" tag="淑女10" url="'.$v['detail_url'].'" rest="'.$v['num'].'" price="'.$v['price'].'" alt="'.$v['title'].'" miniUrl="'.C('UNIQLOURL').'mini.php/Index/index/num/'.$v['num_iid'].'">
              </li>';
	}
...
public function getgood(){
   ...
   foreach($redlist as $k=>$v){
	...
	$v['title'] = iconv('utf8','gbk',$v['title']);
    $tstr.='<li>
                <img data-original="http://uniqlo.bigodata.com.cn/'.$v['pic_url'].'" id="10" place="家居2" tag="淑女10" url="'.$v['detail_url'].'" rest="'.$v['num'].'" price="'.$v['price'].'" alt="'.$v['title'].'">
              </li>';
	}
