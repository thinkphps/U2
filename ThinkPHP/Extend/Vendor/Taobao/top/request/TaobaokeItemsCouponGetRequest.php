...
class TaobaokeItemsCouponGetRequest
{
	...
	/** 
	 * <p>这里目前使用的是前台类目ID<B><a href="http://open.taobao.com/support/question_detail.htm?id=111299">点我查看如何获取</a></B></p>
<p>由于目前的API<B><a href="http://api.taobao.com/apidoc/api.htm?path=cid:3-apiId:122">taobao.itemcats.get</a></B>只能获取到商品后台类目，因此预计会在2012-08-24将该cid统一成商品后台类目</p>
	 **/
	private $cid;
